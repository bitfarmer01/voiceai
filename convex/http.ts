...
// The VAPI *server webhook* envelope (unwrapMessage / extractToolCalls / readers)
// has a single owner — see convex/lib/vapiWire.ts. The client SDK-message shape
// is parsed separately in lib/vapi/use-vapi-call.ts (different payload, separate
// bundle).
import { asString, extractToolCalls, unwrapMessage } from "./lib/vapiWire";
